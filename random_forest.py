...
class RandomForest(object):
    ...
    def _bootstrapping(self, XX, n):
        ...
        #samples_t = [] # sampled dataset
        #labels_t = []  # class labels for the sampled records
        


        #print(n,len(XX),XX[0])
        for i in range(n):
            row = randint(0, (len(XX)-1))
            #print(row)
    ...
    def bootstrapping(self, XX):
        ...
        for i in range(self.num_trees):
            ...
            #data_sample, data_label = self._bootstrapping(XX, 15)
            #print(data_sample, data_label)
    ...
    def fitting(self):
        ...
        for i in range(self.num_trees):
            ...
            #print(self.decision_trees[i].root)
      #pass      
...
def main():
    ...
    #print("Checking lenght of Y & Y Pred",len(y),len(y_predicted))
